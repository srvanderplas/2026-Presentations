...
::: {.column}
::: { .r-stack}
![](grammar-data.svg){fig-alt="A graphical representation of a spreadsheet with 4 variables in columns" .fragment}

![](grammar-aesthetics.svg){fig-alt="A plot with the x- and y- axis highlighted, showing only a grid. A paint bucket, paintbrush, and set of dotted and dashed lines illustrate other aesthetics." .fragment}

![](grammar-aesthetics-mapping.svg){fig-alt="A plot with the x- and y- axis highlighted, showing only a grid. A paint bucket, paintbrush, and set of dotted and dashed lines illustrate other aesthetics. Below the plot, four columns of data in a table layout are shown, with arrows from each column to the x- and y- axis, dotted and dashed lines, and paintbrush." .fragment}

![](grammar-aesthetic-mapping-geom-line.svg){fig-alt="Geometric mappings for a line - x and y position. An additional variable could be mapped to line color or type, if there are multiple lines." .fragment}

![](grammar-aesthetic-mapping-geom-rect.svg){fig-alt="Geometric mappings for a rectangle - x, y, length, and width. An additional variable could be mapped to color." .fragment}

![](grammar-aesthetic-mapping-geom-circle.svg){fig-alt="Geometric mappings for a circle - x and y position (for the center), radius, and fill." .fragment} 

...
![](satfaces_map_1024.png){fig-alt="Fully saturated color map from xkcd color survey." .fragment width="50%"}
...
::: r-stack
![](associations-temp.png){fig-alt="A map from the 1880 statistical atlas which shows the average January temperature across the continental US." .fragment width="80%"}

![](association-map-of-1880-election.jpg){fig-alt="Map of 1880 election results showing the Republican party in blue and the Democratic party in red. The colors commonly used for each party were not consistently assigned until color TV became common." .fragment width="80%"}
:::

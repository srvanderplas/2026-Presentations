...
::: {.column width="10%"}
::: fragment
![](data-binary-small.svg){fig-alt="a rectangle of 0s and 1s representing binary data."}
:::
:::

::: {.column width="20%"}
::: fragment
![](programmer.svg){fig-alt="a human seated at an old fashioned computer"}
:::
:::
...
:::
::: fragment
![](world.svg){width="30%" fig-alt="The globe"}
:::

...
3.  [CSI: Statistics and Scientific Foundations](#csi-stats) <!-- Error Rates and Scientific Foundations in Forensics -->

Slide Link: 
{{< qrcode https://srvanderplas.github.io/2026-Presentations/02-utah-state/ width=300 height=300 >}}
...
::: columns
::: {.column width="30%"}
{{< qrcode https://doi.org/10.1080/10618600.2022.2140668 width=200 height=200 >}}
...
:::
::: {.column width="30%"}
{{< qrcode https://jds-online.org/journal/JDS/article/1317 width=200 height=200 >}}
...
:::
::: {.column width="30%"}
{{< qrcode https://doi.org/10.1080/10618600.2025.2476097 width=200 height=200 >}}
...
## Exp. Growth & Log Scales {.r-fit-text}
...
1.  Replicate Eye Fitting Straight Lines using the you-draw-it tool (4 charts) 
...
-   Testing method(s) matched to level of engagement

-   Examine the effect of choices [across]{.emph .red} engagement

-   System-level modeling of data: 
    - Integrate different measurement methods
    - Standard methods to process and analyze common qualitative data patterns
...
[President's Council of Advisors on Science and Technology]{.emph .red style="position:absolute;top:70px"}
...
-   Empirical testing by
    ...
    -   demonstrating the method is **repeatable** and **reproducible** and
    -   estimating the method's accuracy

-   **subjective** disciplines
    -   examiner is a "black box"
    -   Studies designed with $n$ examiners and $k$ independent tests.
...
## Status of Forensic Disciplines
...
[Joint work with]{.emph} [**Heike Hofmann**]{.emph .darkorange} and [**Alicia Carriquiry**]{.emph .darkpurple}
...
[Oregon courts recently ruled that firearms and toolmark evidence are not admissible because the methods are not scientifically valid. (Oct 2025, 340 Or.App. 661, State v. Adams)]{.fragment .emph .red}
...
## [My]{.emph .cerulean} Conclusions

::: incremental

- How we communicate statistics (and data) matters! 💬

    - Graphics are a vital tool 📊

- Statisticians have an [ethical obligation]{.emph .cerulean} to challenge faulty statistics

- Fundamentals make a difference!
    - sampling, measurement, experimental design, probability

:::

![](https://media2.giphy.com/media/v1.Y2lkPTc5MGI3NjExM2NnbzBhaHV3OHN4ZTAyaWYzYXIxbzM1cG9hNW1zM25mZ3RzYmR6ZCZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/GIQkxve3gvNHG/giphy.gif){.fragment fig-alt="A gif of Mr. Miyagi teaching the karate kid how to paint." width="50%" fig-align="center"}

## Questions? {.center}

![](https://media2.giphy.com/media/v1.Y2lkPTc5MGI3NjExYzI4MGd5eG41cjc1dG0yMmg3bzAwMHh3aDh3ZDk3amgwc2g4YWgxMCZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/6a4udhSXVdp20zVDIz/giphy.gif){fig-alt="A gif of a penguin asking questions" width="50%" fig-align="center"}
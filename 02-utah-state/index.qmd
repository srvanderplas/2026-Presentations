...
3.  [Algorithms for Forensic Evidence](#csi-algs)
4.  [CSI: Statistics and the Fundamentals of Science](#csi-stats) <!-- Error Rates and Scientific Foundations in Forensics -->
...
-   What Comes Next: A Constructive Vision for Firearms and Toolmark Analysis
...
![](fig/Chart-Perception-Process.svg){.fragment fig-alt="A timeline showing different levels of graphical engagement, starting with initial perception, then using gestalt grouping, leveraging domain knowledge, fittting visual statistics and storytelling, visually conducted inference,  to grouping"}
...
# CSI: Statistics {#csi-stats .center background-image="../images/dna.jpg" background-opacity="50%" background-size="cover"}
...
# Flipping The Script:<br/>[Algorithms to Mimic Perception]{.emph .green}

![](../images/CSAFE%20Logo.svg){fig-alt="Logo for the Center for Statistics and Applications in Forensic Evidence (CSAFE)" width="50%" align="center"}

## Goals

-   Develop algorithms for matching spent ammunition  [Features engineered based on examiners' visual focus 👁️🔬]{.fragment .emph .meddarkblue}

-   Compare these algorithms to examiner performance

-   Algorithms must be explainable

    -   Visual diagnostics [Where did things "go wrong"?]{.emph .fragment .green}
        -   Process for manual override on critical steps
    -   Promote examiner (and jury) **conceptual** understanding [(through graphics)]{.emph .purple .fragment}
...
[Joint work with]{.emph}[**Heike Hofmann**]{.darkorange} and [**Will Ju**]{.darkgreen} and [**Ganesh Krishnan**]{.darkblue}, extending work by 
[**Heike Hofmann**]{.darkorange}, [**Alicia Carriquiry**]{.darkpurple}, and [**Eric Hare**]{.darkcerulean}
...
## Matching Striated Evidence

- Scanned with 3D Confocal Light Microscope
- Data is a matrix of height values in $\mu$m

::: {.r-stack}
![](../images/bullet-scan.png){.fragment fig-alt="A 3d scan rendering of a bullet land engraved area."}

![](../images/bullet-crosscut.png){.fragment fig-alt="Pick a crosscut across the bullet surface that isn't too damaged."}

![](../images/bullet-land-profiles.png){.fragment fig-alt="Profiles of each land of two scanned bullets"}

![](../images/bullet-grooves.png){.fragment fig-alt="Locate the grooves (lands are depressed from the groove)."}

![](../images/bullet-signatures.png){.fragment fig-alt="Remove the surface super structure to get a flat signature."}

![](../images/bullet-signatures-align.png){.fragment fig-alt="Align signatures using maximum cross-correlation function."}
...
- Striation Alignment
  ...
  - Identify "striations" - significant departures from the mean

  - Count aligned/matching striations (per mm)    
  [consecutive matching striae]{.emph .meddarkblue}
...
- Mathematical measures of alignment
  - (maximum) Cross-correlation between signatures

  - 

  - Euclidean distance between signatures

  - Lag between signatures at max alignment (per mm)

  - Length of aligned signatures (mm)


## Feature Extraction

- Measures of total signal
  
  - Combined striae height    
[measure of how much signal exists]{.emph .meddarkblue .fragment}

  - Variation in height measurement of aligned signature


## Machine Learning

- Feed pairwise features into a random forest to predict source -- same or different?
...
# Wire Cuts<br/> [& Scientific Foundations]{.emph .orange .slightly-small .fragment} {background-image="../images/bomb-fragments.png" background-opacity="50%" background-size="cover"}

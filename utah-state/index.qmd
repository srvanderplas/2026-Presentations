...
#| fig-dpi: 300
if (!file.exists("../data/stars.csv")) download.file("https://raw.githubusercontent.com/astronexus/HYG-Database/main/hyg/v3/hyg_v38.csv", destfile = "../data/stars.csv")
library(magrittr)
library(dplyr)
library(stringr)
library(ggplot2)
...
Data from the [HYG Database](https://github.com/astronexus/HYG-Database). Shows stars within 500 AU.
